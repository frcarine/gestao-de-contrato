...
namespace app\class\dompdf\lib\html5lib;

use class\dompdf\lib\html5lib\DOMDocument;
use class\dompdf\lib\html5lib\DOMNodeList;
use class\dompdf\lib\html5lib\HTML5_Tokenizer;

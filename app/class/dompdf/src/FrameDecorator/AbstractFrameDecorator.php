...
use app\class\dompdf\src\FrameDecorator\Block;
use app\class\dompdf\src\FrameDecorator\Page;
use DOMElement;
use DOMNode;
use DOMText;
...
use app\class\dompdf\src\Frame\FrameTreeList;
...
abstract class AbstractFrameDecorator extends Frame
{
     ...
     *
     * @var \app\class\dompdf\src\FrameReflower\AbstractFrameReflower
     */
    protected $_reflower;
    ...
    /**
     * @return \app\class\dompdf\src\FrameReflower\AbstractFrameReflower
     */

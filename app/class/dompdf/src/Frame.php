...
use app\class\dompdf\src\LineBox;
use app\class\dompdf\src\Css\Style;
use app\class\dompdf\src\Frame\FrameList;
...
class Frame
{
     ...
     *
     * @var \app\class\dompdf\src\FrameDecorator\AbstractFrameDecorator
     */
    ...
    /**
     * @return \app\class\dompdf\src\FrameDecorator\AbstractFrameDecorator
     */
    ...
    /**
     * @param \app\class\dompdf\src\FrameDecorator\AbstractFrameDecorator $decorator
     */
    public function set_decorator(\app\class\dompdf\src\FrameDecorator\AbstractFrameDecorator $decorator)
    {
...
//       return "";
        ...
        if ($this->_decorator instanceof \app\class\dompdf\src\FrameDecorator\Block) {
            $str .= "Lines:<pre>";
            foreach ($this->_decorator->get_line_boxes() as $line) {
                foreach ($line->get_frames() as $frame) {
                    if ($frame instanceof \app\class\dompdf\src\FrameDecorator\Text) {
                        $str .= "\ntext: ";

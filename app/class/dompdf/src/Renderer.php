...
use app\class\dompdf\src\JavascriptEmbedder;
use app\class\dompdf\src\PhpEvaluator;
use app\class\dompdf\src\Renderer\AbstractRenderer;
use app\class\dompdf\src\Renderer\Block;
use app\class\dompdf\src\Renderer\Image;
use app\class\dompdf\src\Renderer\ListBullet;
use app\class\dompdf\src\Renderer\TableCell;
use app\class\dompdf\src\Renderer\TableRowGroup;
use app\class\dompdf\src\Renderer\Text;
    ...
    protected function _render_frame($type, $frame)
    {
        ...
        if (!isset($this->_renderers[$type])) {
            ...
            switch ($type) {
                ...
                case "inline":
                    $this->_renderers[$type] = new \app\class\dompdf\src\Renderer\Inline($this->_dompdf);
                    break;

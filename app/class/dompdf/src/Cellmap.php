...
use app\class\dompdf\src\FrameDecorator\Table as TableFrameDecorator;
use app\class\dompdf\src\FrameDecorator\TableCell as TableCellFrameDecorator;
    ...
    public function add_frame(Frame $frame)
    {
        ...
        if ($display === "table-row" ||
            ...
            foreach ($frame->get_children() as $child) {
                ...
                if (!($child instanceof \app\class\dompdf\src\FrameDecorator\Text) && $child->get_node()->nodeName !== 'dompdf_generated') {
